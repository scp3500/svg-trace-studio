...
function animHTML(svgText, src, o, beam) {
  ...
  const layerCSS = beam ? '' : (
    ...
    + '.pg{will-change:opacity,clip-path}\n'
    + '.playing .pg{animation:.55s cubic-bezier(.45,.05,.25,1) both;animation-delay:var(--d)}\n'
    + '.playing .wipe-r{animation-name:wipe-r}.playing .wipe-l{animation-name:wipe-l}\n'
    + '.playing .wipe-d{animation-name:wipe-d}.playing .dab{animation-name:dab}\n'
    ...
    + '@media (max-width:860px){.playing .pg{animation-name:pgfade-m}.playing .wipe-r,.playing .wipe-l,.playing .wipe-d,.playing .dab{animation-name:pgfade-m}}\n'
    + '@keyframes pgfade-m{0%{opacity:0;transform:scale(.97)}55%{opacity:1}100%{opacity:1;transform:none}}\n'
